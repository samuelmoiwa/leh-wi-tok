...
const ThemeSwitcher = () => {
  ...
  return (
    <Surface style={[styles.container, { backgroundColor: bgColor }]} elevation={1}>
      <TouchableOpacity onPress={toggleTheme} activeOpacity={0.85} style={styles.touchable}>
        <View style={styles.row}>
          ...
          <View style={styles.textContainer}>
            <Text style={[styles.title, { color: textColor }]}>Display Mode</Text>
...
const styles = StyleSheet.create({
  container: { marginHorizontal: 16, marginVertical: 8, borderRadius: 20, overflow: 'hidden' },
